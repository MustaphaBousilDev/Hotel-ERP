...
export default {
  props: {
    ...
    width: {
      type: String,
      default: '512',//default width
    },
    height: {
      type: String,
      default: '512',//default height
    },
    color: {
      type: String,
